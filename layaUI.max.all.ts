...
module ui.game_ui.eluosizhuanpan.component {
    export class AnNiu1UI extends View {
        ...
        createChildren():void {
            ...
            this.createView(ui.game_ui.eluosizhuanpan.component.AnNiu1UI.uiView);
        }
    }
}
...
module ui.game_ui.eluosizhuanpan.component {
    export class DaoJiShiUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.eluosizhuanpan.component.DaoJiShiUI.uiView);
        }
    }
}
...
module ui.game_ui.eluosizhuanpan.component {
    export class QiuUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.eluosizhuanpan.component.QiuUI.uiView);
        }
    }
}
...
module ui.game_ui.eluosizhuanpan.component {
    export class TouXiangUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.eluosizhuanpan.component.TouXiangUI.uiView);
        }
    }
}
...
module ui.game_ui.eluosizhuanpan.component {
    export class TouXiangWzUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.eluosizhuanpan.component.TouXiangWzUI.uiView);
        }
    }
}

module ui.game_ui.eluosizhuanpan {
    export class ELuoSiLunPanUI extends View {
		...
		public seat0:ui.game_ui.eluosizhuanpan.component.TouXiangWzUI;
		public seat1:ui.game_ui.eluosizhuanpan.component.TouXiangWzUI;
		public seat2:ui.game_ui.eluosizhuanpan.component.TouXiangWzUI;
		public seat3:ui.game_ui.eluosizhuanpan.component.TouXiangWzUI;
		public seat4:ui.game_ui.eluosizhuanpan.component.TouXiangWzUI;
		public seat5:ui.game_ui.eluosizhuanpan.component.TouXiangWzUI;
		...
		public main_player:ui.game_ui.eluosizhuanpan.component.TouXiangUI;
		public box_tip:Laya.Box;
		public clip_status:Laya.Clip;
		public list_record:Laya.List;
		public btn_record:Laya.Button;
		public box_time:ui.game_ui.eluosizhuanpan.component.DaoJiShiUI;
...
module ui.game_ui.eluosizhuanpan {
    export class GoUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.eluosizhuanpan.GoUI.uiView);
        }
    }
}
...
module ui.game_ui.eluosizhuanpan {
    export class GuiZeUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.eluosizhuanpan.GuiZeUI.uiView);
        }
    }
}
...
module ui.game_ui.eluosizhuanpan {
    export class JieSuanUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.eluosizhuanpan.JieSuanUI.uiView);
        }
    }
}
...
module ui.game_ui.eluosizhuanpan {
    export class StopUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.eluosizhuanpan.StopUI.uiView);
        }
    }
}
...
module ui.game_ui.eluosizhuanpan {
    export class ZhuanPanUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.eluosizhuanpan.ZhuanPanUI.uiView);
        }
    }
}
